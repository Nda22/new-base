...
let handler = async (m, { conn, args, usedPrefix }) => {
    try {
        ...
        } else conn.reply(m.chat, `uang kamu tidak cukup untuk melakukan reme sebesar ${count} BGL`.trim(), m)
    } catch (e) {
        console.log(e)
        m.reply('Error!!')
        if (DevMode) {
